    ...
    public void parseOutExcel2(Map<String,String> cellData){
        ...
        for (Map.Entry entry : cellData.entrySet()){
           ...
           /* CellReference cr = new CellReference("A1");
            ...
            //CellReference cr = new CellReference((String) entry.getKey());
            ...
            //CellReference cellReference = new CellReference("B3");
            //Row row = outputFileSheet.getRow(cellReference.getRow());
            //Cell cell = cellReferenceIsWithinRange

           // CellReference.convertColStringToIndex("c1");
          //  System.out.println(CellReference.convertColStringToIndex("c1"));


            //System.out.println(CellReference.convertColStringToIndex(String.valueOf(entry.getKey())));
